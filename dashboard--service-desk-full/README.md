...
- **飞书多维表格**：[产业金融服务台工单列表](https://haidgroup.feishu.cn/base/Ds5qb6T8aaPTmVsDipbcL8xUnyf)
- **更新频率**：每天早上9:00（北京时间）
...
| `BITABLE_APP_TOKEN` | 多维表格 Token | 多维表格 URL 中获取（默认为 Ds5qb6T8aaPTmVsDipbcL8xUnyf）|
