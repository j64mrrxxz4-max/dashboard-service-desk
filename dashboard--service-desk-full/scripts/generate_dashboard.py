...
BITABLE_APP_TOKEN = os.environ.get('BITABLE_APP_TOKEN', 'Ds5qb6T8aaPTmVsDipbcL8xUnyf')
        ...
        <div class="info-row">
            ...
            <div class="info-card">
                ...
                <div class="stat-item">
                    ...
                    <span class="stat-value"><a href="https://haidgroup.feishu.cn/base/Ds5qb6T8aaPTmVsDipbcL8xUnyf" target="_blank">查看</a></span>
                </div>
                <div class="stat-item">
